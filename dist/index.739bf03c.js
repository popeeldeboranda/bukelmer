...
var l = [
    ...
    function l(e) {
        ...
        } : p, d = l.smooth, f = void 0 === d || d, v = l.mouseMultiplier, g = void 0 === v ? 1 : v, w = l.smoothTouch, m = void 0 !== w && w, y = l.touchMultiplier, b = void 0 === y ? 2 : y, S = l.direction, N = void 0 === S ? "vertical" : S, O = l.gestureDirection, z = void 0 === O ? "vertical" : O, R = l.infinite, W = void 0 !== R && R, M = l.wrapper, T = void 0 === M ? window : M, k = l.content, j = void 0 === k ? document.body : k;
        ...
        }, window.lenisVersion = "0.2.20", s.options = {
            duration: h,
            easing: u,
            smooth: f,
            mouseMultiplier: g,
    ...
    return a.start = function() {
        ...
        if (null != t) {
            ...
            p += r, this.targetScroll = this.infinite ? p : Math.max(0, Math.min(p, this.limit)), !this.smooth || s ? (this.scroll = this.lastScroll = this.targetScroll, this.setScroll(this.targetScroll)) : this.animate.to(this, {
                duration: c,
                easing: h,
